...
void Demo::Render() {
	...
	// point light 1
	glUniform3f(glGetUniformLocation(this->shadowmapShader, "pointLights[0].position"), 4.0f, 4.0f, 4.0f);
	...
	// point light 2
	glUniform3f(glGetUniformLocation(this->shadowmapShader, "pointLights[1].position"), 4.0f, 4.0f, 4.0f);
	...
	// point light 3
	glUniform3f(glGetUniformLocation(this->shadowmapShader, "pointLights[2].position"), 4.0f, 4.0f, 4.0f);
	...
	// point light 4
	glUniform3f(glGetUniformLocation(this->shadowmapShader, "pointLights[3].position"), 4.0f, 4.0f, 4.0f);
...
void Demo::BuildLemariDepan()
{
	...
	float vertices[] = {
		...
		-2.5, 1.5,  0.5, 1, 0, 0.0f,  1.0f,  0.0f,  // 17
		-2.5, 1.5, -0.5, 1, 1, 0.0f,  1.0f,  0.0f,  // 18
		0.5, 1.5, -0.5, 0, 1, 0.0f,  1.0f,  0.0f,   // 19

		// bottom
		-2.5, -0.5, -0.5, 0, 0,  0.0f,  -1.0f,  0.0f, // 20
		0.5, -0.5, -0.5, 1, 0,  0.0f,  -1.0f,  0.0f,  // 21
		0.5, -0.5,  0.5, 1, 1,  0.0f,  -1.0f,  0.0f,  // 22
		-2.5, -0.5,  0.5, 0, 1,  0.0f,  -1.0f,  0.0f, // 23
	};
